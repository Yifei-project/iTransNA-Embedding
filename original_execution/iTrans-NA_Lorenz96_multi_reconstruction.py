...
class net_configs:  # multivariate
    def __init__(self) -> None:
        self.seq_len = 10             # W, also equal to 'time_window' below
        self.pred_len = 8             # L_{pred}
        self.d_model = 64             # the encoder dimension
        self.n_heads = 16              # attention head number
...
if __name__ == "__main__":
    ...
    for id in range(1,101):
        ...
        file_path = "./data/Lorenz96/lorenz96_N8_no"+str(id)+".h5"
        ...
        h5f = h5.File('./results/iTrans-NA/Lorenz96-multi/lorenz96_multi_no'+str(id)+'.h5', 'w')
    ...
    for id in range(1,101):
        ...
        # save the final reconstruction result
        h5f = h5.File('./results/iTrans/Lorenz96-multi/lorenz96_multi_no'+str(id)+'.h5', 'w')
        dset = h5f.create_dataset("Embedding", Recon.shape, dtype='f')
        dset[...] = Recon
        h5f.close()
