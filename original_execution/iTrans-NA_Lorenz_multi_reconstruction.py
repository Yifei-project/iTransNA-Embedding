...
if __name__ == "__main__":
    ...
    for id in range(1,101):
        ...
        h5f = h5.File('./results/iTrans-NA/3D-lorenz-multi/lorenz_multi_no'+str(id)+'.h5', 'w')
    ...
    for id in range(1,101):
        ...
        # save the final reconstruction result
        h5f = h5.File('./results/iTrans/3D-lorenz-multi/lorenz_multi_no'+str(id)+'.h5', 'w')
        dset = h5f.create_dataset("Embedding", Recon.shape, dtype='f')
        dset[...] = Recon
        h5f.close()
